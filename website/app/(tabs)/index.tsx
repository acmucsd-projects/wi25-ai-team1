      ...
      <SafeAreaView style={styles.safe}>
        ...
        >
          <View style={styles.logoRow}>
            <Image
              source={require("@/assets/images/acm-ucsd-logo.png")}
              style={styles.logo}
              resizeMode="contain"
            />
            <Image
              source={require("@/assets/images/acm-projects-ucsd-logo.png")}
              style={styles.logo}
              resizeMode="contain"
            />
          </View>
          ...
          <ThemedText style={GlobalStyles.paragraph}>
            We all love haikyuu and volleyball.
          </ThemedText>
          ...
          <ThemedText style={GlobalStyles.paragraph}>
            Improve our model's accuracy, and deploy to gather a real user base.
          </ThemedText>
          <ThemedText style={GlobalStyles.sectionTitle}>
            Try Our Predictor
          </ThemedText>
